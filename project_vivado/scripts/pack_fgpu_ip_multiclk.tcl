...
#conditions to display or not m1 through m3 ports
...
ipx::add_bus_parameter FREQ_HZ [ipx::get_bus_interfaces s_aclk -of_objects [ipx::current_core]]
ipx::add_bus_parameter FREQ_HZ [ipx::get_bus_interfaces m0_aclk -of_objects [ipx::current_core]]
ipx::add_bus_parameter FREQ_HZ [ipx::get_bus_interfaces m1_aclk -of_objects [ipx::current_core]]
ipx::add_bus_parameter FREQ_HZ [ipx::get_bus_interfaces m2_aclk -of_objects [ipx::current_core]]
ipx::add_bus_parameter FREQ_HZ [ipx::get_bus_interfaces m3_aclk -of_objects [ipx::current_core]]

#conditions to display or not clks and resets from m1 to m3
set_property enablement_dependency {spirit:decode(id('PARAM_VALUE.num_master_intf')) >= 2} [ipx::get_bus_interfaces m1_aresetn -of_objects [ipx::current_core]]
set_property enablement_dependency {spirit:decode(id('PARAM_VALUE.num_master_intf')) = 4} [ipx::get_bus_interfaces m2_aresetn -of_objects [ipx::current_core]]
set_property enablement_dependency {spirit:decode(id('PARAM_VALUE.num_master_intf')) = 4} [ipx::get_bus_interfaces m3_aresetn -of_objects [ipx::current_core]]
set_property enablement_dependency {spirit:decode(id('PARAM_VALUE.num_master_intf')) >= 2} [ipx::get_bus_interfaces m1_aclk -of_objects [ipx::current_core]]
set_property enablement_dependency {spirit:decode(id('PARAM_VALUE.num_master_intf')) = 4} [ipx::get_bus_interfaces m2_aclk -of_objects [ipx::current_core]]
set_property enablement_dependency {spirit:decode(id('PARAM_VALUE.num_master_intf')) = 4} [ipx::get_bus_interfaces m3_aclk -of_objects [ipx::current_core]]
